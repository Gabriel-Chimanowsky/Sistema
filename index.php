...
// Contador baseado no log imutável de criação (não muda se contas forem deletadas)
$contasNaoSync = (int) $pdo->query("SELECT COUNT(*) FROM log_criacao_contas WHERE slack_sync = 0")->fetchColumn();
